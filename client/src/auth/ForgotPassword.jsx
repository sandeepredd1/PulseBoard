...
import { ArrowLeft, ArrowRight, Mail, ShieldCheck, Sparkles, Shield } from "lucide-react";
        ...
        <div className="group relative overflow-hidden rounded-[40px] bg-white/40 backdrop-blur-2xl p-8 shadow-2xl shadow-purple-200/50 border border-white/60 transition-all duration-500 hover:shadow-[0_30px_80px_rgba(139,92,246,0.25)] hover:-translate-y-2">
          ...
          <div className="relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Email */}
              <div>
                <label htmlFor="email" className="mb-2 block text-xs font-semibold text-gray-700 tracking-wide">
                  Email Address
                </label>
            ...
            <div className="text-center mt-6">
              <Link
                to="/login"
                className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition-all hover:text-purple-600 hover:gap-3"
              >

...
export default function Login() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 px-4 py-8 sm:px-6">
      {/* Animated Background */}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <Link
                    to="/forgot-password"
                    className="inline-block text-xs font-medium text-purple-600 transition-all hover:scale-105 hover:text-purple-700 hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  name="rememberMe"
                  type="checkbox"
                  className="h-4 w-4 rounded border-gray-300 text-purple-600 accent-purple-600 transition-all focus:ring-2 focus:ring-purple-500"
                />

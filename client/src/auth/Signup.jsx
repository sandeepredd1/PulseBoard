...
import { ArrowRight, Mail, LockKeyhole, User, Sparkles, Shield, CheckCircle, Eye, EyeOff } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md px-4 py-8">
        <div className="group relative overflow-hidden rounded-[40px] bg-white/40 backdrop-blur-2xl p-8 shadow-2xl shadow-purple-200/50 border border-white/60 transition-all duration-500 hover:shadow-[0_30px_80px_rgba(139,92,246,0.25)] hover:-translate-y-2">
          ...
          <div className="relative">
            ...
            {/* Success */}
            {success && (
              <div className="mb-5 flex items-center gap-3 rounded-2xl border border-emerald-200/80 bg-emerald-50/90 backdrop-blur-sm px-4 py-3 text-sm text-emerald-600 shadow-lg shadow-emerald-100/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Name */}
              <div>
                <label className="mb-2 block text-xs font-semibold text-gray-700 tracking-wide">
                  Full Name
                </label>
                <div className="group/input relative">
                  <User className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all group-focus-within/input:text-purple-500 group-focus-within/input:scale-110" size={18} />
                  <input
                    required
                    value={form.name}
                    onChange={(event) =>
              ...
              <div>
                ...
                <p className="mt-1.5 text-[10px] text-gray-400">Must be at least 8 characters</p>
              </div>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <Link to="/login" className="font-semibold text-purple-600 transition-all hover:text-purple-700 hover:underline hover:scale-105 inline-block">
                Sign in
              </Link>
            </p>
